...
int max_l_ending_at[10001];
int max_r_ending_at[10001];
int max_l_ending_below[10001];
int max_r_ending_above[10001];
bool reachable_l[10001];
bool reachable_r[10001];
...
int main(){
	...
	for(int i = 2; i <= n; ++i){
		...
		for(int j = 0; j < k; ++j){
			if( i - a[k] >= 1 and reachable_l[i - a[j]]){
				reachable_l[i] = 1;
