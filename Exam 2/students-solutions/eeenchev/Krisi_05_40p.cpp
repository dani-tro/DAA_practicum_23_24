...
int n, m, k, q, i, j, from, to, t, current_node;
int queries[1000002];
long long distance[1000002];
std::priority_queue<std::pair<short, long long>, std::vector<std::pair<short, long long>>, std::greater<std::pair<short, long long>>> pq;
std::vector<std::pair<short, int>> graph[1000002];
