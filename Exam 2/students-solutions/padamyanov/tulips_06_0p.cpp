...
void addToGroup(int n, int m, Pair* groups, size_t& groupSize, int x, int y)
{
    ...
    {
        addToGroup( n, m, groups, groupSize, x + 1, y);
    }
    ...
    {
        addToGroup(n, m, groups, groupSize, x, y + 1);
    }
...
int main()
{
    ...
    for (size_t i = 0; i < n; i++)
    {
        for (size_t j = 0; j < m; j++)
        {
            ...
            {
                //cout << i << " " << j << endl;
                addToGroup(n, m, groups, groupSize, i, j);
                answer++;
