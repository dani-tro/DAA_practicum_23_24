...
int indexOf(size_t element, const size_t* arr, size_t startIdx, size_t endIdx)
{
...
void insertAt(size_t element, size_t* arr, int& size, size_t index)
{
    size++;
