...
int main()
{
    ...
    for(int i=0;i<n;i+=2)
    {
        edges[idx]={i, i+1, findPrice(beetles[i].first,beetles[i].second,beetles[i+1].first,beetles[i+1].second)};
        ++idx;
    }

    for(int i=0;i<n;i+=3)
    {
        edges[idx]={i, i+2, findPrice(beetles[i].first,beetles[i].second,beetles[i+2].first,beetles[i+2].second)};
        ++idx;
    }
