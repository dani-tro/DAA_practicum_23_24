...
int main(){
	...
	std::stable_sort(points + 1, points + 1 + n + 2 * m, [](callable x, callable y){ return x.prio < y.prio; });
	std::stable_sort(points + 1, points + 1 + n + 2 * m, [](callable x, callable y){ return x.i < y.i; });
